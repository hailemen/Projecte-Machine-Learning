...
trabajos = {'Administración': 'profesional', 'Tecnico': 'profesional',
            ...
            'Desempleado': 'otro', 'Estudiante': 'otro', 'Jubilado': 'retirado'}
...
# Predicción
perfil_map = {
    0: "1: Línea Standard: Cuentas de ahorro con beneficios para saldos altos, Planes de pensiones individuales, Seguros de vida o de protección familiar y Productos bancarios vinculados a la vivienda",
    1: "2: Línea Flex: Cuentas de ahorro sin comisiones, Depósitos a corto plazo con flexibilidad, Préstamos personales con tasas bajas y Productos Bancarios Digitales",
